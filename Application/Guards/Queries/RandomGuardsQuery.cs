...
{
    public class RandomGuardsQuery(int month, int year) : IRequest<List<GuardDto>>
    {
        public int Month { get; set; } = month;
        public int Year { get; set; } = year;
    }

    public class RandomGuardsQueryHandler(IMediator mediator) : IRequestHandler<RandomGuardsQuery, List<GuardDto>>
    {
        private readonly IMediator _mediator = mediator;

        public async Task<List<GuardDto>> Handle(RandomGuardsQuery request, CancellationToken cancellationToken)
        {
            ...
            AssignGuards(request, workers, vacations, assignedDates, allAssignedDates, guards, totalDays, startOfMonth);
        ...
        private void AssignGuards(RandomGuardsQuery request, List<WorkerDto> workers, List<VacationDto> vacations,
